...
//spellchecker:words context errors http github process over websocket proto wisski distillery internal component server admin socket actions wdlog pkglib errorsx
import (
	"context"
	"errors"
	"fmt"
